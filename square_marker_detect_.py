    ...
    for r in rect_cand:
        if correct_gradient(gray_img,r):
            ...
            if marker is not None:
                ...
                marker = {'id':msg,'id_confidence':id_confidence,'verts':r.tolist(),'soft_id':soft_msg,'perimeter':cv2.arcLength(r,closed=True),'centroid':centroid.tolist(),"frames_since_true_detection":0, "rotation": angle}
                if visualize:
